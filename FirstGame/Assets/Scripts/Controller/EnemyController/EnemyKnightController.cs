...
public class EnemyKnightController : CreatureController
{
    ...
    protected override void AttackB() 
    {
        ...
        Debug.Log($"Our Castle이 {_knightStat.Attack}의 피해를 받음!");
        Managers.Game.MyHp = Math.Max(0, Managers.Game.MyHp - _knightStat.Attack);
